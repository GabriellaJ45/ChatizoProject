package com.example.gabriella.chatizoproject.communication;
...
import com.example.gabriella.chatizoproject.interfacer.SocketerInterface;
        ...
        public void run() {
            try {
                ...
                while ((inputLine = in.readLine()) != null)
                {
                    ...
                    {
                        clientSocket.shutdownInput();                        clientSocket.shutdownOutput();
                        clientSocket.close();
